    ...
    return (
      ...
      <div className="App">
       ...
       <Route exact path='/cards' component={Cards}></Route>
        ...
        <Route exact path='/drop' render={() => { return <Dropdown ParentbuttonVal={this.buttonValMethod} Parentbutton={this.state.buttonVal} /> }}></Route>
        ...
        <Route exact path='/bulkhrletter' render={() => { return <BulkHR empData={this.state.emp} navBarData={this.state.show} /> }}></Route>
        ...
        <Route exact path='/bulkconfirmationletter' render={() => { return <BulkConfirmationLetter empData={this.state.emp} /> }}></Route>
       ...
       <Route exact path='/bulkcertificateletter' render={() => { return <BulkCertificateLetter empData={this.state.emp} /> }}></Route>
        ...
        <Route exact path='/bulkdepuationletter' render={() => { return <BulkDepuationLetter empData={this.state.emp} /> }}></Route>
        ...
        <Route exact path='/bulkdesignationletter' render={() => { return <BulkDesignationLetter empData={this.state.emp} /> }}></Route>
        ...
        <Route exact path='/bulkincrementletter' render={() => { return <BulkIncrementLetter empData={this.state.emp} /> }}></Route>
        ...
        <Route exact path='/bulkrelivingletter' render={() => { return <BulkRelivingLetter empData={this.state.emp} /> }}></Route>
        ...
        <Route exact path='/bulktrainingcommit' render={() => { return <BulkTrainingCommit history={this.props.history} empData={this.state.emp} /> }} ></Route>
        ...
        <Route exact path='/bulkexitletter' render={() => { return <BulkExitLetter empData={this.state.emp} /> }} ></Route>
        ...
        <Route exact path='/bulkintershipletter' render={() => { return <BulkInternshipLetter history={this.props.history} empData={this.state.emp} /> }} ></Route>
        ...
        <Route exact path='/bulkofferletter2' render={() => { return <BulkOfferLetter2 history={this.props.history} empData={this.state.emp} /> }} ></Route>
        ...
        <Route exact path='/bulkintentletter' render={() => { return <BulkIntent history={this.props.history} empData={this.state.emp} /> }} ></Route>
        ...
        <Route exact path='/bulkhrpolicy' render={() => { return <BulkHrPolicy history={this.props.history} empData={this.state.emp} /> }} ></Route>
        ...
        <Route exact path='/bulkbdpolicy' render={() => { return <BulkBDPolicy history={this.props.history} empData={this.state.emp} /> }} ></Route>
        ...
        <Route exact path='/bulkprojectpolicy' render={() => { return <BulkProjectPolicy history={this.props.history} empData={this.state.emp} /> }} ></Route>
        ...
        <Route exact path='/bulkconsultantoffer' render={() => { return <BulkConsultantOffer history={this.props.history} empData={this.state.emp} /> }} ></Route>
        ...
        <Route exact path='/bulksalaryrevision' render={() => { return <BulkSalaryRevision history={this.props.history} empData={this.state.emp} /> }} ></Route>

        <Route exact path='/InputDeliveryPolicy' render={() => { return <InputDeliveryPolicy empData={this.state.emp} history={this.props.history} clicked={this.employee.bind()} /> }} ></Route>
        <Route exact path='/DeliveryPolicy' render={() => { return <DeliveryPolicy history={this.props.history} empData={this.state.emp} /> }} ></Route>
        <Route exact path='/bulkdeliverypolicy' render={() => { return <BulkDeliveryPolicy history={this.props.history} empData={this.state.emp} /> }} ></Route>

        <Route exact path='/InputITPolicy' render={() => { return <InputITPolicy empData={this.state.emp} history={this.props.history} clicked={this.employee.bind()} /> }} ></Route>
        <Route exact path='/ITPolicy' render={() => { return <ITPolicy history={this.props.history} empData={this.state.emp} /> }} ></Route>
        <Route exact path='/bulkitpolicy' render={() => { return <BulkITPolicy history={this.props.history} empData={this.state.emp} /> }} ></Route>

        <Route exact path='/InputNoDueLetter' render={() => { return <InputNoDueLetter empData={this.state.emp} history={this.props.history} clicked={this.employee.bind()} /> }} ></Route>
        <Route exact path='/NoDueLetter' render={() => { return <NoDueLetter history={this.props.history} empData={this.state.emp} /> }} ></Route>
        <Route exact path='/bulknodueletter' render={() => { return <BulkNoDueLetter history={this.props.history} empData={this.state.emp} /> }} ></Route>

        <Route exact path='/withWaterMark' render={() => { return <Example showWatermark={this.showWatermark.bind()} /> }} ></Route>
        <Route exact path='/withUrl' render={() => { return <CheckSign showUrl={this.showUrl.bind()} /> }} ></Route>
        <Route exact path='/DigitalSignature' component={ReactFirebaseFileUpload}></Route>
