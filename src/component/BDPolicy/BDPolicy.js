// This is BDPolicy letter file. 
// In this letter by proving required data the user will get BDPolicy letter,
// with letter header and footer in the document format.
                  ...
                  <div className="card-body pb-0">
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <br />
                        <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>{this.state.employee.name}  </strong>, aged about {this.state.employee.age} years, {this.state.employee.salute}&nbsp; {this.state.employee.fatherName}, Residing at, {this.state.employee.address}. Here in after referred to as the “Employee” or the “Second Party”, of the OTHER PART (hereinafter referred to as the ‘Employee’) which expression be deemed to include {this.props.empData.gender.gender2} heirs, successors, executors and permitted assigns of the Other Part.</p>
