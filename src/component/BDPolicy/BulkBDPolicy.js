//This is bulk uploading BDPolicy letter file. 
//In this file by uploading bulk BDPolicy letter details with excel format, 
//The user will get all BDPolicy letter in the document format with letter header and footer.
// when the user clicks create pdf button the user gets all the document in the pdf format.
...
export class BulkBDPolicy extends Component {
    ...
    if (this.state.employee.length > 0) {
      return (
        employeeDetails.map((item, index) => {
          toLowerCaseGender = item.gender.gender1.toLowerCase()
                      ...
                      <div className="card-body pb-0">
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>This Confidentiality and Non-Disclosure Agreement is entered on this <span ><strong>{joiningDate.getDate()}<sup>{this.nth(joiningDate.getDate())}</sup>&nbsp;{moment(this.state.employee.joiningDate).format('MMMM YYYY')}</strong></span></p>
                            ...
                            <br />
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>{item.employeeName}  </strong>, aged about {item.age} years, {item.salute === 'Mr.' ? "S/o" : "D/o"}&nbsp; {item.fatherName}, Residing at, {item.address}. Here in after referred to as the “Employee” or the “Second Party”, of the OTHER PART (hereinafter referred to as the ‘Employee’) which expression be deemed to include {item.gender.gender2} heirs, successors, executors and permitted assigns of the Other Part.</p>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={12}>
                              <li>Employee will have contacts with placement officers at various Colleges. Employee must not carry the Colleges of our Company to {item.gender.gender2}  new Company or wherever {toLowerCaseGender} joins. {item.gender.gender1} must not establish contacts with old or existing customers of our Company</li>
                            </ol>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={1}>
                              <li>During Employment and upon exit, Employee should not replicate Business Strategies and process work flow in any other Company, be it {item.gender.gender2} own firm or in any company {toLowerCaseGender} joins.</li>
                            </ol>
                            <ol style={{ listStyleType: 'lower-alpha' }} start={2}>
                              <li style={{ textAlign: 'justify' }}>At any given point of time Employee quits the Organization {toLowerCaseGender}  cannot establish contacts with Employees &amp; Customers of Company for benefit of {item.gender.gender2} own, be it {toLowerCaseGender} joins a new company or to {item.gender.gender2} own firm.</li>
                            </ol>
                            <ol style={{ listStyleType: 'lower-alpha' }} start={3}>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={6}>
                              <li>Upon Exit from the Company, Employee must not carry the Customers of our Company to {item.gender.gender2} new Company or wherever {toLowerCaseGender} joins. {item.gender.gender1} must not establish contacts with old or existing customers of our Company</li>
                            </ol>
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={7}>
...
export default withRouter(BulkBDPolicy)