...
export class ITPolicy extends Component {
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <ol style={{ listStyleType: 'lower-alpha' }}>
                          ...
                          <br />
                          <li style={{ textAlign: 'justify' }}>The Employee agrees and acknowledges that Confidential Information disclosed to the Employee during the course of {this.props.empData.gender.gender2} employment in trust and confidence solely for the performance of {this.props.empData.gender.gender3.toLowerCase()} assigned tasks at the Company and such confidential information includes various trade secrets and business practices of the Company which shall not be utilized or disclosed, in perpetuity, by the Employee to any third party whatsoever.</li>
                          <br />
...
export default withRouter(ITPolicy)