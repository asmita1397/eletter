//This is bulk uploading IT Policy letter file. 
//In this file by uploading bulk details with excel format, 
//The user will get all IT Policy letter in the document format with letter header and footer.
...
export class BulkITPolicy extends Component {
  ...
  sendData() {
    ...
    this.props.history.push('/InputITPolicy');
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha' }} start={1}>
                              <li style={{ textAlign: 'justify' }}>The Employee agrees and undertakes that during the period of Employment, the Employee shall not in any way, directly or indirectly, on {item.gender.gender2} own behalf or on behalf of any third party, solicit or otherwise approach any client / customer of the Company for the purpose of employment or to provide any services to such client / customer of the Company.</li>
                            </ol>
                      ...
                      <div className="card-body pb-0">
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <ul style={{ listStyleType: 'disc', paddingLeft: 60 }}>
                              ...
                              <li style={{ textAlign: 'justify' }}>Company Assets</li>
                              <li style={{ textAlign: 'justify' }}>Software Licenses</li>
                              <li style={{ textAlign: 'justify' }}>Access to Networks</li>
                              <li style={{ textAlign: 'justify' }}>Data Management & Confidentiality</li>
                              <li style={{ textAlign: 'justify' }}>Vendor Engagement & Database</li>
                              <li style={{ textAlign: 'justify' }}>Network Restrictions </li>
                              <li style={{ textAlign: 'justify' }}>User ID, Passwords & Access to Employee Data, Shared Data</li>
                              <li style={{ textAlign: 'justify' }}>User ID, Passwords & Access to Employee Data, Shared Data</li>
                      ...
                      <div className="card-body pb-0">
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>I, <strong>{item.employeeName}</strong> do hereby solemnly affirm that I shall abide by the Confidentiality Policies of Test Yantra Software Solution, at all times.</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
...
export default withRouter(BulkITPolicy)