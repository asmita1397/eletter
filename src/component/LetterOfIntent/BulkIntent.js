//This is bulk uploading Intent letter file. 
//In this file by uploading bulk details with excel format, 
//The user will get all Intent letter in the document format with letter header and footer.
...
export class BulkIntent extends Component {
        ...
        if (this.state.employee.length > 0) {
            return (
                this.state.employee.map((item,index) => {
                    ...
                    toJoiningDate = new Date((item.trainingStartDate - (25567 + 2)) * 86400 * 1000)
                                    ...
                                    <PdfContainer id={index} name={item.employeeName} createPdf={this.createPdf}>
                                        <div className="card" ref={this.bodyRef} id="AFourPage">
                                            <div className="card-body pb-0">
                                                ...
                                                <div style={{ textAlign: 'justify', margin: 0 }}><strong>Location: {item.companyLocation}</strong></div>
                                                <p style={{ textAlign: 'justify' }}><strong><br></br></strong></p>
                                                <p style={{ textAlign: 'justify', margin: 0 }}><strong>Dear &nbsp;{item.employeeName},</strong></p>
                                                ...
                                                <p style={{ textAlign: 'justify', margin: 0 }}>&nbsp;</p>
                                                <p style={{ textAlign: 'justify', margin: 0 }}>In this regards we are offering you as<strong>&nbsp; {item.designation} </strong>, the details of the same are in <strong>ANNEXURE A </strong>to this letter.</p>
                                                <p style={{ textAlign: 'justify', margin: 0 }}>&nbsp;</p>
                                        ...
                                        <div class="card" id="AFourPage" style={{ marginTop: value.pdfVal ? '0px':'20px' }}>
                                            <div class="card-body">
                                                    ...
                                                    <table style={{ width: 860, height: 84, textAlign: 'left' }} border="1px">
                                                        <tbody>
                                                            <tr style={{ height: 21 }}>
                                                                ...
                                                                <td style={{ width: 464, height: 21, textIndent: 15 }}><strong>{item.designation}</strong></td>
                                                            </tr>
                                                            <tr style={{ height: 21 }}>
                                                                ...
                                                                <td style={{ width: 464, height: 21, textIndent: 15 }}>
                                                                    <div>
                                                                        <div style={{ textAlign: 15 }}><strong>&nbsp;{item.reportingManager}</strong></div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr style={{ height: 21 }}>
                                            ...
                                            <div>
                                                <div>
                                                    <div>
                                                        ...
                                                        <p style={{ textAlign: 'justify', margin: 0 }}><strong><span style={{ position: 'absolute' }}>Date:</span><span style={{ position: 'absolute', right: '123px' }}>Test Yantra Software Solutions (India) Pvt Ltd</span></strong></p>
                                                    </div>
...
export default withRouter(BulkIntent)