        ...
        if (designation.match(/^[a-zA-Z\s]*$/)) {
          if (designation.length < 3 || designation.length > 30) {
            this.setState({
              ...
              designationErrMsg:
                "Designation Contains MIN 3 and MAX 30 Character Only!!",
            });
          }
        } else {
          this.setState({
        ...
        if (employeeName.match(/^[a-zA-Z\s]*$/)) {
          if (employeeName.length < 3 || employeeName.length > 20) {
            this.setState({
              ...
              employeeNameErrMsg:
                "Employee Name Contains min 3 and max 20 Character Only!!",
            });
          }
        } else {
          this.setState({
                        ...
                        <form onSubmit={this.pass}>
                          ...
                          <div className="row">
                            <div className="col-6">
                              <MDBInput
                                autocomplete="off"
                                onKeyPress={this.hideEmployeeId}
                            ...
                            <div className="col-6">
                              <MDBInput
                                autocomplete="off"
                                onKeyPress={this.hideDesignation}
                          ...
                          <div className="row" style={{ padding: 0 }}>
                            <div className="col-12 p-0">
                              {this.state.showJoiningDate ? (
                                <div id="errordiv" className="container-fluid">
                                  {this.state.errorMsgJoiningDate}
                                </div>
                              ) : null}
                            </div>
                          </div>
