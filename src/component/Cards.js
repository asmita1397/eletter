                    ...
                    <div className="row ">
                        ...
                        <div className="column">
                            <Link to='/hr' >
                                ...
                                <div className=" card-css " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto' }} src={HR} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputConfirmation'>
                                ...
                                <div className="card-css " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto' }} src={confirm} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputcertificateLetter'>
                                ...
                                <div className="card-css " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto' }} src={certificate} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputDepuationLetter'>
                                ...
                                <div className="card-css" >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto' }} src={Deputation} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputDesignationLetter'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto' }} src={Designation} className="card-css-img-top" alt="..." />
                                    <div style={{ color: '#343A40' }}><h6 className="font-weight-bold">Designation Letter</h6></div>
                                </div></Link>
                        ...
                        <div className="column">
                            <Link to='/InputIncrementLetter'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto' }} src={increment} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputIntentLetter'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto' }} src={offer} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            ...
                            <Link to='/InputRelivingLetter'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto' }} src={relieve} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            ...
                            <Link to='/InputTrainingCommitLetter'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto' }} src={TrainingCommit} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputExitLetter'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={exit} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            ...
                            <Link to='/InputInternship'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={intern} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputOfferLetter2'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={offerletter2} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputHrPolicy'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={hrPolicy} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputBDPolicy'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={BDPolicy} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputConsultantOffer'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={ConsultantOffer} className="card-css-img-top" alt="..." />
                                    <div style={{ color: '#343A40' }}><h6 className="font-weight-bold">Consultant Letter</h6></div>
                                </div></Link>
                        </div>
                        <div className="column">
                            <Link to='/InputSalaryRevision'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={salaryRevision} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputProjectPolicy'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={ProjectPolicy} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputITPolicy'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={ITPolicy} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputDeliveryPolicy'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={DeliveryPolicy} className="card-css-img-top" alt="..." />
                        ...
                        <div className="column">
                            <Link to='/InputNoDueLetter'>
                                ...
                                <div className="card-css  " >
                                    <img style={{ width:"70%", marginLeft: 'auto', marginRight: 'auto', }} src={NoDue} className="card-css-img-top" alt="..." />
                                    <div style={{ color: '#343A40' }}><h6 className="font-weight-bold">NoDue Letter</h6></div>
                                </div></Link>
