//This is bulk uploading HR policy letter file. 
//In this file by uploading bulk details with excel format, 
//The user will get all HRPolicy letter in the document format with letter header and footer.
...
export class BulkHrPolicy extends Component {
...
export default withRouter(BulkHrPolicy)