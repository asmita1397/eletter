                    ...
                    <div class="mainHeader">
                        <div className="main" >
                            <PdfContainer id={"hrletter"} name={this.state.employee.employeeName} createPdf={this.createPdf}>
                                ...
                                <div className="card" id="AFourPage" style={{ marginTop: value.pdfVal ? '20px' : '20px' }}>
...
<div>
<label for="files" class="btn" style={{color:'Black',border:'2px solid black',padding:'5px',position:'absolute', marginLeft:'27px',fontWeight:'100px', marginTop:'-85px', backgroundColor:'orange'}}>Upload Digital Signature</label>
            <input 
            type="file" 
            name="myImage" 
            accept=".png"
...
style={{visibility:'hidden'}}
            ...
            <img style={{position:"absolute",marginLeft: '-2px',marginTop: '-98px',width:'300px',height:'100px'}}  src={this.state.image} />
