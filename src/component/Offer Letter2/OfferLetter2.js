// This is Offer letter file. 
// In this letter by proving required data the user will get all data in the document format.
                        ...
                        <div class="card-body">
                            <div className="card-body">
                                ...
                                <div>
                                    ...
                                    <br />
                                    <p style={{  }}><strong>NON - STATUTORY BENEFITS</strong></p>
                    ...
                    <div className="card" id="AFourPage" style={{ marginTop: value.pdfVal ? '0px':'20px' }}>
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <p style={{}}>NOW THIS EMPLOYMENT AGREEMENT SHALL WITNESSETH AS FOLLOWS;</p>
                    ...
                    <div className="card" id="AFourPage" style={{ marginTop: value.pdfVal ? '0px':'20px' }}>
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <ol style={{  }} start={3}>
                                    <li style={{  }}><u>TERM AND TERMINATION:</u></li></ol>
                    ...
                    <div className="card" id="AFourPage" style={{ marginTop: value.pdfVal ? '0px':'20px' }}>
                        <div className="card-body pb-0">
                            ...
                            <div>
                                ...
                                <br />
                                <p style={{ textAlign: 'justify' }}>IN  WITNESS  THERE OF  the parties hereto have set and subscribed their respective signatures and </p>
                                <p style={{ textAlign: 'justify' }}>seal on the day, month and year first written herein above:</p>
...
<div>
<label for="files" class="btn" style={{color:'Black',border:'2px solid black',padding:'5px',position:'absolute', marginLeft:'40px',fontWeight:'100px', marginTop:'-55px', backgroundColor:'orange'}}>Upload Digital Signature</label>
            <input 
            type="file" 
            name="myImage" 
            accept=".png"
...
style={{visibility:'hidden'}}
            ...
            <img style={{position:"absolute",marginTop: '-50px',width:'300px',height:'100px'}}  src={this.state.image} />
