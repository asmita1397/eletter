//This is bulk uploading Delivery Policy letter file. 
//In this file by uploading bulk details with excel format, 
//The user will get all Delivery Policy letter in the document format with letter header and footer.
...
export class BulkDeliveryPolicy extends Component {
  ...
  sendData() {
    ...
    this.props.history.push('/InputDeliveryPolicy');
                      ...
                      <div className="card-body pb-0">
                        <div>
                          ...
                          <div>
                            ...
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>This Confidentiality and Non-Disclosure Agreement is entered on this <span ><strong>{joiningDate.getDate()}<sup>{this.nth(joiningDate.getDate())}</sup>&nbsp;{moment(item.joiningDate).format('MMMM YYYY')}</strong></span></p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>&nbsp;</strong></p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>BY AND BETWEEN:</strong></p>

                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>Test Yantra Software Solutions (India) Private Limited, a company incorporated under the Companies Act, 1956, having its registered office at No.88, Brigade Chambers, 3rd floor, Gandhi Bazaar Main Road, Basavanagudi, Bengaluru, Karnataka - 560004 represented by its Human Resource Department (hereinafter may be referred to as the “<strong>Company</strong>”, which expression shall, unless repugnant to the context or meaning thereof, be deemed to include its successors and permitted assigns) of the ONE PART;</p>
                            <p>&nbsp;</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>AND</p>
                            <br />
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>{item.employeeName}</strong>, aged about {item.age} years, {item.salute === "Mr." ? "S/o" : "D/o"} {item.fatherName}, Residing at, {item.address}. Here in after referred to as the “Employee” or the “Second Party”, of the OTHER PART.</p>
                            ...
                            <ol style={{ listStyleType: 'upper-alpha' }} start={2}>
                              <li style={{ textAlign: 'justify' }}>The Employee has been employed by the Company vide Employment Agreement dated <span ><strong>{joiningDate.getDate()}<sup>{this.nth(joiningDate.getDate())}</sup>&nbsp;{moment(item.joiningDate).format('MMMM YYYY')}</strong></span> and is employed in the position of ‘Business Development’. In the role as BD, {item.gender.gender1.toLowerCase()}  is responsible for BD related matters including but not limited to enrolling the Candidates &amp; Employees for interviews with the Customers etc. In this role, {item.gender.gender1.toLowerCase()} shall have access to Candidate database, employee details, Customer Database, salary details etc. Since the Employee has access to confidential information, the Company has to protect its confidential information.</li>
                            </ol>
                            <ol style={{ listStyleType: 'upper-alpha', textAlign: 'justify' }} start={3}>
                              <li style={{ textAlign: 'justify' }}>To achieve the aforesaid objective and also to ensure confidentiality, restricted use and non-disclosure of confidential information disclosed to or known by the Employee as a consequence of or through {item.gender.gender2} association with the Company, the Employee is executing this Agreement.</li>
                            </ol>
                          </div>
                      ...
                      <div className="card-body pb-0">
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <p style={{paddingLeft: 30 }}><strong>NOW THIS AGREEMENT WITNESSETH AS UNDER:</strong></p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>&nbsp;</strong></p>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha' }} start={1}>
                              <li >The Employee agrees to hold all Confidential Information in trust and confidence in perpetuity for the Company and, except as set forth in Clause 2)(b) below and elsewhere in this Agreement or as otherwise may be authorized by the Company in writing, the Employee will not use or disclose to any person, firm or enterprise, or use for {item.gender.gender2}  benefit, any Confidential Information;</li>
                            </ol>
                            <ol style={{ listStyleType: 'lower-alpha' }} start={2}>
                              <li style={{ textAlign: 'justify' }}>The Employee understands and agrees that {item.gender.gender1.toLowerCase()} is being given access to Confidential Information in confidence and trust and solely for use for the performance of the services required to be performed by the Employee during {item.gender.gender2}  employment in the Company for the furtherance of the business interests of the Company.</li>
                            </ol>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={12}>
                              <li>Employee will have contacts with placement officers at various Colleges. Employee must not carry the Colleges of our Company to {item.gender.gender2}  new Company or wherever {item.gender.gender1.toLowerCase()} joins. {item.gender.gender1} must not establish contacts with old or existing customers of our Company</li>
                            </ol>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha' }} start={17}>
                              <li style={{ textAlign: 'justify' }}>Employee shall ensure {item.gender.gender1.toLowerCase()} will not commit Dual Employment, which means that {item.gender.gender1.toLowerCase()} cannot work for Commercial Benefit during Employment with any third party as Consultant, be it a Company / firm/ Proprietorship / Partner/ Person / Customer or any other Organization.</li>
                            </ol>
                            <ol style={{ listStyleType: 'lower-alpha' }} start={18}>
                              <li style={{ textAlign: 'justify' }}>Employee must not Discuss about {item.gender.gender2}  Individual Salaries, Compensation Benefits and personal Information with subordinates within the Work premises, as well as in Public Forum.</li>
                            </ol>
                          </div>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={20}>
                              <li>During Employment or upon Exit from Company, Employee shall ensure that {item.gender.gender1.toLowerCase()} shall not make False branding about the Company.</li>
                            </ol>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={23}>
                              <li>Employee cannot assist or refer {item.gender.gender2} colleagues or any other person who is associated to our Company for attending Interviews with our Competitors or to some other company, which leads to attrition of employment in our company.</li>
                            </ol>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={1}>
                              <li>During Employment and upon exit, Employee should not replicate Business Strategies and process work flow in any other Company, be it {item.gender.gender2} own firm or in any company {item.gender.gender1.toLowerCase()} joins.</li>
                            </ol>
                            <ol style={{ listStyleType: 'lower-alpha' }} start={2}>
                              <li style={{ textAlign: 'justify' }}>At any given point of time Employee quits the Organization {item.gender.gender1.toLowerCase()} cannot establish contacts with Employees &amp; Customers of Company for benefit of {item.gender.gender2} own, be it {item.gender.gender1.toLowerCase()} joins a new company or to {item.gender.gender2} own firm.</li>
                            </ol>
                            <ol style={{ listStyleType: 'lower-alpha' }} start={3}>
                              <li style={{ textAlign: 'justify' }}>As per Exit Policy of the Company, while Employee decides to Exit from the Company {item.gender.gender1.toLowerCase()} has to hand over the complete information & database maintained by {item.gender.gender3} throughout the tenure of {item.gender.gender2} employment. {item.gender.gender1} should not carry any data to {item.gender.gender2} personal account, as well ensure {item.gender.gender1.toLowerCase()} shall not erase or wipe out any official data. Any at given point of time if {item.gender.gender1.toLowerCase()} exhibits unprofessionalism the Company shall take strict action against the Employee and shall file legal action against Employee.</li>
                            </ol>

                            <ol style={{ listStyleType: 'lower-alpha' }} start={4}>
                              <li style={{ textAlign: 'justify' }}>Upon Exit from the Company, Employee must not demotivate or utilize Company resources (Material / Employee / Customer/ Database) for {item.gender.gender2} Commercial benefit. {item.gender.gender1} must not form a new Company by pulling the&nbsp;“Company “resources. {item.gender.gender1} cannot hire the Employees to {item.gender.gender2} new Company / firm {item.gender.gender1.toLowerCase()} joins.&nbsp;</li>
                            </ol>
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={5}>
                            ...
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={6}>
                              <li>Upon Exit from the Company, Employee must not carry the Customers of our Company to {item.gender.gender2} new Company or wherever {item.gender.gender1.toLowerCase()} joins. {item.gender.gender1} must not establish contacts with old or existing customers of our Company</li>
                            </ol>
                            <ol style={{ listStyleType: 'lower-alpha', textAlign: 'justify' }} start={7}>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <div>
                              ...
                              <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong >Human Resource</strong><strong ><span style={{ position: 'absolute', left: '681px' }}> Employee Name:</span></strong><span style={{ position: 'absolute', left: '843px', wordBreak: 'break-word', right: '105px' }}>{item.employeeName}</span> </p>
                      ...
                      <div className="card-body pb-0">
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>I, <strong>{item.name}</strong> do hereby solemnly affirm that I shall abide by the Confidentiality Policies of Test Yantra Software Solution, at all times.</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
                            ...
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>Employee Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{item.employeeName}</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>Designation&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{item.designation}</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>Date of Joining&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{joiningDate.getDate()}<sup>{this.nth(joiningDate.getDate())}</sup>&nbsp;{moment(item.joiningDate).format('MMMM YYYY')}</p>
                          </div>
...
export default withRouter(BulkDeliveryPolicy)